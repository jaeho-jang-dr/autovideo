...
REPORTS = {"ko": "c91fd4d9-6358-435e-953b-f78a2e192e0c",
           "en": "4618b32a-4507-4981-a910-c6aeb9255632"}
PODCASTS = {"ko": "ccc2e208-732d-4a33-9521-9f0de51d85bf",
            "en": "bad8c5a2-eca6-42fb-bde4-9285abe64ed8"}
...
def make_notes(lang, mdpath):
    ...
    title = "숫자 표현과 날짜, 시간" if lang == "ko" else "Numbers, Dates & Time"
    head = (f"# [초급 8주차] {title} — 핵심 요약 노트\n" if lang == "ko"
            else f"# [Beginner Week 8] {title} — Key Summary Notes\n")
