...
if img is not None:
    ...
    # 2. Erase hand (y: 200~270, x: 380~560)
    # Source is empty chalkboard (rows 200~270, cols 200~380)
    patch_hand = img_resized[200:270, 200:380].copy()
    
    # 3. Erase arm (y: 270~460, x: 380~635)
    # Source is empty chalkboard (rows 270~460, cols 200~455)
    patch_arm = img_resized[270:460, 200:455].copy()
    
    test_img = img_resized.copy()
    test_img[200:270, 380:560] = patch_hand
    ...
    out_path = os.path.join(out_dir, "test_face_restored.png")
