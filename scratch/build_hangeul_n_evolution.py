...
def main():
    print("Generating evolution graphic assets (ㄴ)...")
    txt_g = generate_text_lineart("ㄴ", os.path.join(ROOT, "assets", "graphics", "letters", "letter_ㄴ_chalk.png"), font_size=180, stroke_width=6)
    txt_kk = generate_text_lineart("ㄷ", os.path.join(ROOT, "assets", "graphics", "letters", "letter_ㄷ_chalk.png"), font_size=180, stroke_width=6)
    txt_k = generate_text_lineart("ㅌ", os.path.join(ROOT, "assets", "graphics", "letters", "letter_ㅌ_chalk.png"), font_size=180, stroke_width=6)
    
    txt_gang = generate_text_lineart("눈", os.path.join(ROOT, "assets", "graphics", "letters", "word_눈_chalk.png"), font_size=140, stroke_width=5)
    txt_kkot = generate_text_lineart("달", os.path.join(ROOT, "assets", "graphics", "letters", "word_달_chalk.png"), font_size=140, stroke_width=5)
    txt_kong = generate_text_lineart("탑", os.path.join(ROOT, "assets", "graphics", "letters", "word_탑_chalk.png"), font_size=140, stroke_width=5)
    
    obj_river = draw_snow_doodle(os.path.join(ROOT, "assets", "graphics", "obj_snow_chalk.png"))
    obj_flower = draw_moon_doodle(os.path.join(ROOT, "assets", "graphics", "obj_moon_chalk.png"))
    obj_bean = draw_tower_doodle(os.path.join(ROOT, "assets", "graphics", "obj_tower_chalk.png"))
    ...
    # ========================================================
    # 🎥 SCENE 1: 'ㄴ' drawn three times and flies (11.0s)
    # ========================================================
    scene_1_dur = 11.0
    ...
    sub_1 = make_subtitle_clip("니은에 이렇게 획을 보태면 다른 자음으로 확장할수 있고", scene_1_dur, 0.0)
    ...
    output_path = os.path.join(ROOT, "assets", "videos", "jay_whiteboard_n_evolution.mp4")
    ...
    if os.path.exists(sqlite_path):
        ...
        project = "jay_n_evolution"
        scene_no = 1
        scene_name = "Jay_Whiteboard_N_Evolution_Video"
        base_image = "assets/characters/jay_writing_board_side_opaque.png"
        
        c_desc = (
            "Hangeul Consonants ㄴ, ㄷ, ㅌ drawn on chalkboard, flying out to become words 눈, 달, 탑, "
            "which remain next to their corresponding doodles."
        )
        file_path = "assets/videos/jay_whiteboard_n_evolution.mp4"
