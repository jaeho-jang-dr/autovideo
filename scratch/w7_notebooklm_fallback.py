...
REPORTS = {"ko": "e00e251c-1903-4ddc-8462-63b035a506b2",
           "en": "c8579865-95b7-4cd7-986d-0ac927c2da2d"}
PODCASTS = {"ko": "cdbee5a7-9a9c-4bf5-baca-fd29e9336c9e",
            "en": "07c43d6a-f96f-47f7-ac86-a989176cfdad"}
WATCH = [PODCASTS["ko"], PODCASTS["en"], REPORTS["ko"], REPORTS["en"]]   # 전부 in_progress 가능
...
HTML_TPL = """<!doctype html><html><head><meta charset="utf-8"><style>
 ...
 h1 {{ font-size:20pt; border-bottom:3px solid #3a7a6a; padding-bottom:6px; }}
...
def make_notes(lang, mdpath):
    ...
    title = "필수 인사말과 자기소개" if lang == "ko" else "Greetings & Self-Introduction"
    head = (f"# [초급 7주차] {title} — 핵심 요약 노트\n" if lang == "ko"
            else f"# [Beginner Week 7] {title} — Key Summary Notes\n")
