...
extra_syllables = [
    '물', '주', '세', '요', '밥', '맛', '있', '어', '화', '장', '실', '디', '에', '휴', '지', '여', '권', '기', '비', '행', '표', '차', '없', 
    '닭', '앉', '않', '읽', '잃', '짧', '넓', '밟', '맑', '젊', '읊', '끓', '굶', '값', '몫', '넋', '삯', '핥', '흙',
    # 존댓말/동사 어미 및 상용 받침 글자 추가 (사용자 요청 피드백: '습니다'/'했습니다'/'입니다' 등)
    '습', '합', '했', '입', '반', '갑', '맙', '들', '단', '작', '였', '왔', '갔',
    # 발음 법칙용 예시 단어 필수 음절 추가
    '굳', '같', '돋', '꽃', '칼', '날', '독', '립', '백', '낱', '맏', '끝', '붙'
]
