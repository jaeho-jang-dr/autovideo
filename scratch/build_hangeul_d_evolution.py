...
def main():
    ...
    def make_scene_1_frame(t):
        prev_frame_path = os.path.join(ROOT, "assets", "characters", "chalkboard_t_final.png")
    ...
    sub_1 = make_subtitle_clip("이응에 이렇게 획을 보태면 다른 자음으로 확장할수 있고", scene_1_dur - 1.0, 1.0)
    ...
    if has_audio:
        s1_audios = [
            ...
            whoosh_audio.with_start(4.0),
            pop_audio.with_start(4.0),
            
            pop_audio.with_start(3.2),
            whoosh_audio.with_start(6.7),
            pop_audio.with_start(6.7),
            chime_audio.with_start(7.5),
    ...
    output_path = os.path.join(ROOT, "assets", "videos", "jay_whiteboard_d_evolution.mp4")
    ...
    # Save last frame
    last_frame_path = os.path.join(ROOT, "assets", "characters", "chalkboard_d_final.png")
    ...
    if os.path.exists(sqlite_path):
        ...
        project = "jay_d_evolution"
        scene_no = 1
        scene_name = "Jay_Whiteboard_D_Evolution_Video"
        ...
        file_path = "assets/videos/jay_whiteboard_d_evolution.mp4"
