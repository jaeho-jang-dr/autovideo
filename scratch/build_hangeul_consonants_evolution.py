...
def main():
    ...
    output_path = os.path.join(ROOT, "assets", "videos", "jay_whiteboard_consonants_evolution.mp4")
    ...
    if os.path.exists(sqlite_path):
        ...
        project = "jay_consonants_evolution"
        scene_no = 1
        scene_name = "Jay_Whiteboard_Consonants_Evolution_Video"
        ...
        file_path = "assets/videos/jay_whiteboard_consonants_evolution.mp4"
