...
def main():
    ...
    key_name = "zolla_handshake_ref"
    name_kr = "졸라커플_악수레퍼런스"
    name_en = "Zolla_Handshake_Ref"
    filename = "zolla_handshake_ref.png"
    ...
    tags = ["character-base", "reference", "home_vocab", "line-art", "whiteboard", "zollaman", "zollanyeo", view, pose, key_name]
    ...
    """, (key_name, char_id, view, pose, file_path, storage_url, "composed_moviepy", style, tags, method_doc))
