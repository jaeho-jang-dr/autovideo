...
def main():
    ...
    local_path = os.path.join(ROOT, "home_vocab", "injun_sitting_chair.png")
    if not os.path.exists(local_path):
        print(f"[ERR] File not found at {local_path}")
        return 1
        
    bucket_filename = "injun_sitting_chair.png"
    ...
    try:
        ...
        tags = ["character-base", "reference", "home_vocab", "line-art", "korean", "injun", "front", "sitting", "injun_sitting_chair"]
        ...
        """, ("injun_sitting_chair", "injun", "front", "sitting", "home_vocab/injun_sitting_chair.png", storage_url, "reference2img", style, tags, method_doc))
