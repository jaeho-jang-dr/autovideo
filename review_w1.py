...
VIDEO = os.path.join(CG, "hangeul_w1_stickman_np_ko_burned.mp4")   # 한글자막 박힌 KO(선희) — 리뷰용
FB_JSON = os.path.join(CG, "review_w1_feedback.json")
FB_MD = os.path.join(CG, "review_w1_feedback.md")
PORT = 8911

def load_scenes():
    p = os.path.join(CG, "hangeul_w1_stickman_np.ko.srt")
    scenes = []
...
<div class=left>
  <div class=row><h1>🎬 교정 리뷰 — 한글강의 W1 · 한글의 탄생과 단모음 (선희)</h1>
