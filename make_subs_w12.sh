#!/bin/bash
# W12 5개국어 자막 생성 — Gemini 무료 번역 + 타임스탬프 재조립(필수).
# 원본: hangeul_w12_injun_np.{ko,en}.srt  → w12pkg/{ko,en}_{ko,en,ja,zh,es}.srt
...
SRC_KO="hangeul_birth_vowels/hangeul_w12_injun_np.ko.srt"
SRC_EN="hangeul_birth_vowels/hangeul_w12_injun_np.en.srt"
mkdir -p "$PKG" logs
LOG="logs/subs_w12.log"
: > "$LOG"
