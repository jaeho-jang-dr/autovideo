...
# Path configuration
video_path = r"D:\Entertainments\DevEnvironment\autovideo\binge_watching\scene_0.mp4"
output_path = r"D:\Entertainments\DevEnvironment\autovideo\binge_watching\scene_0_thumbnail.png"
...
def main():
    ...
    # Text content
    title_text = "몰아보기는 정말 우리 몸에 나쁠까?"
    subtitle_text = "정주행 뒤에 숨겨진 도파민과 신체의 역학"
    ...
    # Draw the sprout green text box matching our video layout style
