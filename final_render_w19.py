# -*- coding: utf-8 -*-
"""W19 정식(라이선스) 최종 렌더: Azure 선희(KO)/Emma(EN) + 지은 발음클립(jamo, 여성) → compile_np 4K.
   사용: python final_render_w19.py <ko|en>   ※KO·EN 병렬 금지(순차)
...
sys.exit(subprocess.run([sys.executable, "compile_np.py", "KO-W19", "hangeul_w19_jieun", "4K", lang],
