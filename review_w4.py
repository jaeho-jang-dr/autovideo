...
VIDEO = os.path.join(CG, "hangeul_w4_stickman_ko.mp4")   # 한글자막 박힌 KO(선희) — 리뷰용
FB_JSON = os.path.join(CG, "review_w4_feedback.json")
FB_MD = os.path.join(CG, "review_w4_feedback.md")
PORT = 8917

def load_scenes():
    p = os.path.join(CG, "hangeul_w4_stickman.ko.srt")
    scenes = []
...
<div class=left>
  <div class=row><h1>🎬 교정 리뷰 — 한글강의 W4 · 받침·대표 7음 (선희)</h1>
