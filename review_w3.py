...
VIDEO = os.path.join(CG, "hangeul_w3_stickman_np_ko_burned.mp4")   # 한글자막 박힌 KO(선희) — 리뷰용
FB_JSON = os.path.join(CG, "review_w3_feedback.json")
FB_MD = os.path.join(CG, "review_w3_feedback.md")
PORT = 8916

def load_scenes():
    p = os.path.join(CG, "hangeul_w3_stickman_np.ko.srt")
    scenes = []
...
<div class=left>
  <div class=row><h1>🎬 교정 리뷰 — 한글강의 W3 · 거센소리·된소리 · 명동 (선희)</h1>
