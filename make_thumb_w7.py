# -*- coding: utf-8 -*-
"""W7 인사말·자기소개 썸네일(KO/EN) 1280x720 — 인사동 배경 + 졸라걸 + 인사말 알약 + 타이틀."""
import os
from PIL import Image, ImageDraw, ImageFont, ImageFilter

ROOT = os.path.dirname(os.path.abspath(__file__))
W, H = 1280, 720
BG = os.path.join(ROOT, "assets", "graphics", "bg", "bg_w7_01.png")
CHAR = os.path.join(ROOT, "assets", "graphics", "poses", "madam_jay_waving.png")
...
if __name__ == "__main__":
    make(["인사말과", "자기소개"], "초급 · 7주차", "★ 한국어 공부",
         ["안녕하세요", "감사합니다", "반갑습니다"],
         os.path.join(OUT, "hangeul_w7_thumbnail_ko.jpg"))
    make(["Korean Greetings", "& Self-Intro"], "Beginner · W7", "★ Learn Korean",
         ["안녕하세요", "감사합니다", "반갑습니다"],
         os.path.join(OUT, "hangeul_w7_thumbnail_en.jpg"))
