...
bg_image_path = r"D:\Entertainments\DevEnvironment\autovideo\child_growth_science\scene_0_thumbnail.png"
output_path = r"D:\Entertainments\DevEnvironment\autovideo\child_growth_science\scene_0_thumbnail_korean.png"
...
def main():
    ...
    # 1. Load background and resize to standard 16:9 thumbnail size (1280x720)
    ...
    # 3. Text content
    title_text = "우리 아이 키 얼마나 자랄까요?"
    subtitle_text = "소아 성장의 과학과 숨겨진 비밀"
