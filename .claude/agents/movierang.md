...
# ★★★ 동영상 클립 제작 표준 — 2026-08-10 titan_science 61클립 완주로 확정

사장님 지시: **"이것은 동영상 클립 만들 때 항상 쓸 거야."**
세 기둥 = **①키프레임 선생성 ②Last Image Transition ③Playwright `locator.click()`**.

## ① 키프레임 먼저 만든다

씬마다 **첫 컷(키프레임)을 먼저** 만들어 놓는다. 이게 그 씬의 기준 그림이 된다.
그다음 이어받기 컷(`_b`, `_c`, `_d`)을 사슬로 잇는다.
...
## ③ Playwright `locator.click()` — 좌표를 쓰지 마라
