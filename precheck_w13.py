# -*- coding: utf-8 -*-
"""업로드 전 10가지 체크 (W13). 하나라도 ✗면 업로드 중단."""
import os, re, json, subprocess
os.chdir(r"D:\Entertainments\DevEnvironment\autovideo")
PKG = "hangeul_birth_vowels/w13pkg"
VIDS = {"ko": "hangeul_birth_vowels/hangeul_w13_jieun_np_ko.mp4",
        "en": "hangeul_birth_vowels/hangeul_w13_jieun_np_en.mp4"}
THUMB = "hangeul_birth_vowels/thumb_w13_1280x720.jpg"
ok_all = True
...
# 매니페스트
mf = sum(1 for m in ("ko", "en") if os.path.exists(f"{PKG}/w13_{m}_manifest.json"))
