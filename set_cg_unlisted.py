# -*- coding: utf-8 -*-
"""아이 성장 본편(비공개)을 일부공개로 — 콘텐츠 목록 상태 텍스트 클릭 패턴."""
import sys, os
...
with sync_playwright() as pw:
    ...
    row = pg.locator("ytcp-video-row").filter(has_text="우리 아이 키").first
    ok = False
    ...
    log("공개상태 클릭 " + str(ok))
    pg.wait_for_timeout(2500); pg.screenshot(path="scratch/yt/cgv_1.png")
    try:
    ...
    pg.wait_for_timeout(5000); pg.screenshot(path="scratch/yt/cgv_2.png")
