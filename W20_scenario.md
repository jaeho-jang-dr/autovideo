...
> **범위 고정(★제목 주제 안에서만):** 웹 훈민정음 20주차 2분 핵심영상(`hangeul_w20_stickman`) = "112·119 신고와 약국·병원 이용 등 위급할 때 도움받는 법" 바운더리 안에서만 확장. 참고=NotebookLM 한글교육 노트북(고급4주차, 돌발상황). ★주제를 넘지 않는다(호칭·여행계획 등 다음 주 내용 금지).
