...
CG = os.path.join(ROOT, "turtle_neck_science")
VIDEO = os.path.join(CG, "turtle_neck_science_np_ko_burned_1080.mp4")   # 한글자막 박힌 KO(선희) — 리뷰용
FB_JSON = os.path.join(CG, "review_turtle_feedback.json")
FB_MD = os.path.join(CG, "review_turtle_feedback.md")
PORT = 8914

def load_scenes():
    p = os.path.join(CG, "turtle_neck_science_np.ko.srt")
    scenes = []
...
<div class=left>
  <div class=row><h1>🎬 교정 리뷰 — 거북목 · 한글의 탄생과 단모음 (선희)</h1>
