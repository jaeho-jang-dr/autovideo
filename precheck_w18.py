# -*- coding: utf-8 -*-
"""업로드 전 10가지 체크 (W18). 하나라도 ✗면 업로드 중단.
   ★자막은 API 매니페스트(subs 5개)로 올린다 → 체크4는 subs_upload/W18_*에 5개씩 준비됐는지 본다.
   (precheck_w16.py 복제 — 경로만 W18으로 치환)"""
import os, re, subprocess
os.chdir(r"D:\Entertainments\DevEnvironment\autovideo")
PKG = "hangeul_birth_vowels/w18pkg"
# ★compile_np 4K 모드는 접미사 없이 같은 파일명에 3840x2160으로 저장한다
VIDS = {"ko": "hangeul_birth_vowels/hangeul_w18_madamjay_np_ko.mp4",
        "en": "hangeul_birth_vowels/hangeul_w18_madamjay_np_en.mp4"}
THUMBS = {"ko": "hangeul_birth_vowels/thumb_w18_ko_1280x720.jpg",
          "en": "hangeul_birth_vowels/thumb_w18_en_1280x720.jpg"}
SUBS_DIR = {"ko": "subs_upload/W18_1_한글판", "en": "subs_upload/W18_2_영어판"}
