# -*- coding: utf-8 -*-
"""W13 공개 전환 — ★4K(2160p) 처리 완료를 확인한 뒤에만 public 으로 바꾼다.
사용: python publish_w13_after_4k.py          (즉시 1회 확인 → 되면 공개)
      python publish_w13_after_4k.py --wait   (4K 될 때까지 최대 3시간 폴링 후 공개)
"""
...
if st.get("KO") and st.get("EN"):
    ...
    log("\n=== ⏳ 아직 4K 처리 중 — 공개 전환 보류 ===")
    log("    나중에 다시: python publish_w13_after_4k.py")
    raise SystemExit(1)
