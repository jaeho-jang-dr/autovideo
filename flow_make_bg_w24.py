# -*- coding: utf-8 -*-
"""★W24 배경 생성 — 동영상 4 + 정지 8 (CDP 9222, 2026-08-03).
...
from gen_w24_bg_prompts import BGS

ROOT = os.path.dirname(os.path.abspath(__file__))
os.chdir(ROOT)

PROFILE = os.path.abspath("assets/chrome_profile")
PROMPT_DIR = "W24/bg_prompts"
...
def run_one(pg, key, first):
    ...
    out = os.path.abspath(f"{OUT_DIR}/bg_w24_{key}.{ext}")
