...
SRC="hangeul_birth_vowels/hangeul_w15_jieun_np.en.srt"
...
# 영어판 → 한글판 복사(같은 내용)
for code in ja zh es; do
  s="$OUT/W15_2_영어판/${YTNAME[$code]}.srt"
  t="$OUT/W15_1_한글판/${YTNAME[$code]}.srt"
