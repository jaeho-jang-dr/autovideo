...
VIDS = {"ko": "hangeul_birth_vowels/hangeul_w15_jieun_np_ko.mp4",
        "en": "hangeul_birth_vowels/hangeul_w15_jieun_np_en.mp4"}
THUMBS = {"ko": "hangeul_birth_vowels/thumb_w15_ko_1280x720.jpg",
          "en": "hangeul_birth_vowels/thumb_w15_en_1280x720.jpg"}
SUBS_DIR = {"ko": "subs_upload/W15_1_한글판", "en": "subs_upload/W15_2_영어판"}
...
# 10. 매니페스트 2개 + 자막 5개국어 채워짐(★이번엔 API 업로드)
import json
n = 0
for L in ("ko", "en"):
    p = f"{PKG}/w15_{L}_manifest.json"
