# -*- coding: utf-8 -*-
"""W15 정식(라이선스) 최종 렌더: Azure 선희(KO)/Emma(EN) + 지은 발음클립(jamo, 여성) → compile_np 4K.
...
sys.exit(subprocess.run([sys.executable, "compile_np.py", "KO-W15", "hangeul_w15_jieun", "4K", lang],
