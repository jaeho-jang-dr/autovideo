...
VIDEO = os.path.join(CG, "child_growth_en_review_v2.mp4")  # EN=Alice 기본트랙
...
<title>Correction Review — Child Growth v2 (English)</title>
<style>
...
<div class=left>
  <div class=row><h1>🎬 Review v2 (outro removed) — English / Alice</h1>
    ...
    class H(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            if self.path == "/" or self.path.startswith("/index"):
                ...
                vtt = os.path.join(CG, "child_growth_v2.en.vtt")
